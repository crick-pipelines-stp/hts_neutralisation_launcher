...
def get_args():
    ...
    arg_parser.add_argument(
        "-i", "--input_dir",
        type=str,
        default="/mnt/proj-c19/ABNEUTRALISATION/Titration_raw_data/",
        help="path to directory to monitor for new phenix titration plates"
    )
    arg_parser.add_argument(
        "-l", "--log_file",
        type=str,
        default="/mnt/proj-c19/ABNEUTRALISATION/analysis_logs/neutralisation_titration_watchdog.log",
